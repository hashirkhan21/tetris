...
int point_3[4][2], point_4[4][2], point_5[4][2],point_6[4][2],point_7[4][2];
int point_8[1][2] = {0,0}, point_9[1][2];
...
bool anamoly3(){
        if (point_8[0][0]<0  || point_8[1][1]>=M)
            return 0;
            else if (gameGrid[point_8[0][1]][point_8[0][0]])
        return 0;
    return 1;
};
